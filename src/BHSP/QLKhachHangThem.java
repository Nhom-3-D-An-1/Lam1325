 ...
 * @author Hoàng Quân
 */
public class QLKhachHangThem extends javax.swing.JFrame {
    DefaultTableModel defaultTableModel = new DefaultTableModel();
    private  KhachHangThemServer server = new KhachHangThemServer();

    /**
     * Creates new form View
     */
    public QLKhachHangThem() {
        initComponents();
        HienThi();
    ...
    public void HienThi(){
        ...
        List<KhahHangThem> khachang = KhachHangThemServer.getKhachHang();
        for (KhahHangThem kh : khachang) {
    ...
    private void initComponents() {
        ...
        TblistKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MaKH", "TenKH", "GioiTinh", "DiaChi", "SĐT", "LoaiKH", "ĐiemTV"
            }
        ));
        TblistKhachHang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TblistKhachHangMouseClicked(evt);
            }
        });
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        KhahHangThem kh = new KhahHangThem(ma, ten, GioString, diachi, sdtStr, loaikhachhang, DiemThanhVien);
        KhachHangThemServer.them(kh);
    ...
    // Tìm kiếm khách hàng
    List<KhahHangThem> kh = server.TimkiemKH(searchQuery);
    ...
    private void BTnCongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTnCongActionPerformed
        // TODO add your handling code here:
       int selectedRow = TblistKhachHang.getSelectedRow();
    if (selectedRow >= 0) {
        // Lấy giá trị từ các cột của hàng đã chọn
        String sdt = TblistKhachHang.getValueAt(selectedRow, 4).toString(); // Cột số điện thoại
        String hoTen = TblistKhachHang.getValueAt(selectedRow, 1).toString(); // Cột họ tên
        
        // Gán giá trị vào các thuộc tính của QuanLyBanHang
        QuanLyBanHang111.QuanLyBanHang.hoTenKH = hoTen;
        QuanLyBanHang111.QuanLyBanHang.sdtKH = sdt;
        
        // Thông báo và đóng cửa sổ hiện tại
        JOptionPane.showMessageDialog(this, "Khách hàng đã được chọn!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
    } else {
        JOptionPane.showMessageDialog(this, "Mời chọn khách hàng", "Thông báo", JOptionPane.WARNING_MESSAGE);
    }
    }//GEN-LAST:event_BTnCongActionPerformed

    private void TblistKhachHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblistKhachHangMouseClicked
        // TODO add your handling code here:
        
    }//GEN-LAST:event_TblistKhachHangMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLKhachHangThem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLKhachHangThem().setVisible(true);
            }
        });
    }
