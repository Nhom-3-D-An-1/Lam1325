...
public class QuanLyBanHang extends javax.swing.JFrame {
    private BHSP.QLKhachHangThem bhsp = new BHSP.QLKhachHangThem();
...
//                                JOptionPane.showMessageDialog(null, "Số lượng phải lớn hơn hoặc bằng 1.");
    ...
    void clearForm(){
       ...
       QLKhachHangThem dialogKH = new QLKhachHangThem();
    ...
    private void initComponents() {
        ...
        TbsanPham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Sản Phẩm ", "Tên Sản Phẩm", "Đơn Giá", "Trạng Thái"
            }
        ));
        ...
        jButton6.setText("Làm Mới Table");
    ...
    private void btnchonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnchonActionPerformed
        ...
        chonKH(QuanLyBanHang.hoTenKH, QuanLyBanHang.sdtKH);
    ...
    private void btnthemvaogiohangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemvaogiohangActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            if (exists) {
                ...
                int soluong = (int) cartModel.getValueAt(existingRowIndex, 2);
                soluong++;
                float thanhTien = soluong * giaTien;
                cartModel.setValueAt(soluong, existingRowIndex, 2);  // Cập nhật số lượng
                cartModel.setValueAt(thanhTien, existingRowIndex, 4);  // Cập nhật thành tiền
            } else {
